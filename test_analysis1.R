# create this R file or manually read the required data sets. 
source("readdata.R") 

source("functions1.R") ; source("functions2.R")
...
proc_data <- gen_proc_data_PCA(data_raw,features_all,data_raw$cv_comp_new)
